			...
			<div class="w-fit p-2 flex flex-col justify-between gap-2">
				...
				<div class="flex flex-row justify-around w-full gap-3">
					...
					<div class="flex flex-col justify-center items-start w-fit">
						<span class="text-gray-700 dark:text-gray-400 text-[16px] leading-4.75">
							Logged in as
						</span>
				...
				<RouterLink to="/profile">
					<a class=" w-full flex flex-row items-center justify-start gap-2.5 p-2 rounded-md
				...
				<RouterLink to="/settings">
					<a class="w-full flex flex-row items-center gap-2.5 p-2 rounded-md
						text-gray-900 dark:text-white
						hover:bg-gray-100 dark:hover:bg-[#1E1E1E] hover:text-[#355AFF] dark:hover:text-[#355AFF]
						transition-colors duration-200 cursor-pointer"
					>
				...
				<a
					@click="logout"
					class="w-full flex flex-row items-center gap-2.5 p-2 rounded-md
					text-gray-900 dark:text-white
					hover:bg-gray-100 dark:hover:bg-[#1E1E1E] hover:text-[#355AFF] dark:hover:text-[#355AFF]
					transition-colors duration-200 cursor-pointer"
				>
